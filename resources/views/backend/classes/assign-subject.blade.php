        ...
        <div class="w-full py-12 border-gray-300">
            ...
            @foreach ($assigned->students as $student)
                <div class="bg-white flex items-center justify-between border mb-px border-b-4 border-l-4 border-r-4 border-gray-300">
                    ...
                    <div class="w-1/6 text-right text-gray-600 py-2 font-medium" style="margin-left:2rem">
                        <a style ="width:1.4rem" href="{{ route('student.show',$student->id) }}" class="ml-1 bg-blue-600 block p-1 border border-blue-600 rounded-sm" title="View Profile">
