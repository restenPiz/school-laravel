...
@section('content')
    ...
    <table id="teachersTable" class="min-w-full table-auto border-collapse">
        <thead class="bg-gray-300 text-gray-700 uppercase text-sm font-semibold">
            <tr>
        ...
        <tbody>
            @foreach ($teachers as $teacher)
                <tr class="text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    <td class="px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $teacher->user->name }}</td>
                    <td class="px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $teacher->user->email }}</td>
                    <td class="px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">
                        @foreach ($teacher->subjects as $subject)
                            <span class="bg-gray-200 text-sm mr-1 mb-1 px-2 border rounded-full">{{ $subject->subject_code }}</span>
                        @endforeach
                    </td>
                    <td class="px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $teacher->phone }}</td>
