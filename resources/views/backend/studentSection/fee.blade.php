                ...
                @foreach ($fees as $fee)
                    <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-gray-300">
                        ...
                        <div class="w-2/12 px-4 py-3 flex items-center justify-end">
                            @if ($fee->status !== 'Pago')
                                <button onclick="openModal()" style="background-color: rgb(24, 24, 189); color: white; border-radius: 0.2rem; padding: 6px 12px; display: flex; align-items: center; gap: 5px;">
                            ...
                            <!-- Modal de Pagamento -->
                        <div id="paymentModal" class="fixed inset-0 flex items-center justify-center bg-gray bg-opacity-50 hidden">
                            <div class="bg-white rounded-lg shadow-lg p-6 w-96" style="width: 50vh">
                                <h2 class="text-xl font-semibold text-gray-800 mb-4">Pague via Mpesa</h2>
